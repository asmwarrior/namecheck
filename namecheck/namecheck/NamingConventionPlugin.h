...
private:
     ...
     */
    virtual void visitStringLiteral(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name);
     ...
     * @param name the name to check
     */
    virtual void visitVariableDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name, bool /*isConst*/, const std::string& /*typeName*/);
     ...
     * @param name the name to check
     */
    virtual void visitGlobalConstDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name);
     ...
     * @param name the name to check
     */
    virtual void visitEnumTypeDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name);
     ...
     * @param name the name to check
     */
    virtual void visitEnumValueDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name);
     ...
     * @param name the name to check
     */
    virtual void visitFunctionDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name);
     ...
     * @param name the name to check
     */
    virtual void visitParameterDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name, bool /*isConst*/);
     ...
     * @param name the name to check
     */
    virtual void visitTypeDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name);
    ...
    * @brief checks class name
     ...
     * @param name the name to check
     */
    virtual void visitClassDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name);
     ...
     * @param name the name to check
     */
    virtual void visitUnionDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name);
     ...
     * @param name the name to check
     */
    virtual void visitUnionValueDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name, bool /*isConst*/, const std::string& /*typeName*/);
     ...
     * @param name the name to check
     */
    virtual void visitStructDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name);
     ...
     * @param name the name to check
     */
    virtual void visitNamespaceDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name);
     ...
     * @param name the name to check
     */
    virtual void visitTemplateTypeParameterDeclaration(const NSCompilerApi::GenericTree decl, const NSGppGeneric::DeclarationName& name);
