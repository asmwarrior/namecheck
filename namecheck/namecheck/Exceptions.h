...
//File exceptions
DEFINE_SPECIFIC_EXCEPTION_TEXT(FileNotFound, NamecheckExceptionHierarchy, "The configuration file was not found.");
...
DEFINE_SPECIFIC_EXCEPTION_TEXT(InvalidRegex, NamecheckExceptionHierarchy, "Invalid definition of a regex.");
