/**
 * @file     TraverserCppThree.h
 * @brief    Provides the interface to traverser of the AST tree for C++03.

 * @author   Marcos Diaz
 * @email    marcos.diaz AT tallertechnologies.com
 *
 * Contents: Header file for traverser providing A Traverser of the AST for C++03.
 *
 * System:    traverser
 * Language:  C++
 *
...
#ifndef TRAVERSER_CPP_THREE_H
#define TRAVERSER_CPP_THREE_H
...
class TraverserCppThree : public GenericTraverser
{
