/**
 * @file     TraverserCppEleven.h
 * @brief    Provides the interface to traverser of the AST tree for C++0x.

 * @author   Marcos Diaz
 * @email    marcos.diaz AT tallertechnologies.com
 *
 * Contents: Header file for traverser providing a traverser of the AST for C++0x.
 *
 * System:    traverser
 * Language:  C++
 *
...
#ifndef TRAVERSER_CPP_ELEVEN_H
#define TRAVERSER_CPP_ELEVEN_H
